...
class ObserveBrowseCardsUseCase(
    private val repository: BrowseCardRepository,
) : UseCase<BrowseCardsQuery, Flow<List<CollectibleCard>>> {
    override suspend fun invoke(parameters: BrowseCardsQuery): Flow<List<CollectibleCard>> =
