...
fun sampleBrowseCardEntity(
    ...
    hpPriceCents: Long = 0,
    dPriceCents: Long = 0,
): com.devindie.cmptemplate.data.source.local.browse.BrowseCardEntity =
    _root_ide_package_.com.devindie.cmptemplate.data.source.local.browse.BrowseCardEntity(
        id = id,
        name = name,
        setName = setName,
        condition = condition,
